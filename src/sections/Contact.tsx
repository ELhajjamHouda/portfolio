      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="flex flex-col justify-center gap-6">
            <motion.a href={`mailto:${profile.email}`} whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }} className={cardClass}>
            ...
            {profile.phone && phoneHref ? (
              <motion.a href={`tel:${phoneHref}`} whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }} className={cardClass}>
