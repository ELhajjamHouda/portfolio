...
export function LinkedInProfilePhoto({ src, alt, className = '', onError }: LinkedInProfilePhotoProps) {
  return (
    <div
    ...
    >
      ...
      <div
        className="flex h-full w-full items-center justify-center rounded-full bg-[#f3f2ef] p-[3px] shadow-[0_0_0_1px_rgba(0,0,0,0.08),0_8px_24px_rgba(0,0,0,0.1)] dark:bg-[#38434f] dark:shadow-[0_0_0_1px_rgba(255,255,255,0.08),0_8px_24px_rgba(0,0,0,0.35)]"
      >
